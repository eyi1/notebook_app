...
Note.create(title:"Breakfast", content:"Oatmeal blah blah", notebook_id:"1")
Note.create(title:"Croatia Itinerary", content:"Croatia things blah blah", notebook_id:"1")
Note.create(title:"Kimchi: how to", content:"Kimchi recipe was blah blah", notebook_id:"1")